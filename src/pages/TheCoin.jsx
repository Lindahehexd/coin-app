  ...
  return (
    <Center>
      <VStack m={4} spacing={7} p={8}>
        <Box w={{ sm: "320px", md: "500px", lg: "800px" }} h={{ lg: "400px" }} align="center" justify="center" p={2}>
          <Chart />
        </Box>
        <Divider />
        ...
        <Flex w="100%" justify="center">
          <SimpleGrid columns={[1, 3, 6]} justifyItems={{ base: "center", lg: "space-evenly" }} w="100%">
            <Flex gap={2}>
              <Text>1h:</Text>
              <Text
                fontWeight="medium"
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 2 }} w="100%" justifyItems="center">
          <Text fontWeight="bold" mt={5} fontSize="2xl" >
            24hr High :
            <Badge colorScheme="green" fontSize="md" ml={2}>
              ${thecoin.market_data && thecoin.market_data.high_24h.usd.toLocaleString()}
            </Badge>
          </Text>
          <Text fontWeight="bold" mt={5} fontSize="2xl">
            24hr Low :
            <Badge colorScheme="red" fontSize="md" ml={2}>
